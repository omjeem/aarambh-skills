    ...
    <div className="overflow-auto xl:w-[300px] lg:h-screen ">
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center p-6 border-b">
          ...
          {user && (
            <>
              <h3 className="text-lg font-semibold text-[#020A47]">
                {user.name}
              </h3>
          ...
          <ul className="space-y-2 overflow-y-auto  scrollbar-hide">
            <li
              ...
              className={`flex items-center space-x-3 text-[#020A47] hover:bg-gray-100 p-3 rounded-lg cursor-pointer transition-colors ${
                location.pathname === "/admin/dashboard" ? col : ""
              }`}
            >
            ...
            <li
              onClick={() => handleNavigation("/admin/dashboard/category")}
              className={`flex items-center space-x-3 text-[#020A47] hover:bg-gray-100 p-3 rounded-lg cursor-pointer transition-colors ${
                location.pathname === "/admin/dashboard/category" ? col : ""
              }`}
            >
            ...
            <div className="relative">
              ...
              {isCourseOpen && (
                <ul className="pl-12 mt-2 space-y-2 border-l-2 border-gray-200">
                  ...
                  <li
                    onClick={() =>
                      handleNavigation("/admin/dashboard/courses/add")
                    }
                    className={`flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                      location.pathname === "/admin/dashboard/courses/add"
                        ? "text-[#020A47]"
                        : ""
                    }`}
                  >
                  ...
                  <li
                    onClick={() =>
                      handleNavigation("/admin/dashboard/video/add")
                    }
                    className={`flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                      location.pathname === "/admin/dashboard/video/add"
                        ? "text-[#020A47]"
                        : ""
                    }`}
                  >
                  ...
                  <li
                    onClick={() =>
                      handleNavigation("/admin/dashboard/quiz/add")
                    }
                    className={`flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                      location.pathname === "/admin/dashboard/quiz/add"
                        ? "text-[#020A47]"
                        : ""
                    }`}
                  >
                  ...
                  <li
                    onClick={() =>
                      handleNavigation("/admin/dashboard/project/add")
                    }
                    className={`flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                      location.pathname === "/admin/dashboard/project/add"
                        ? "text-[#020A47]"
                        : ""
                    }`}
                  >
            ...
            <li
              onClick={() => handleNavigation("/admin/dashboard/bundle/manage")}
              className={`flex items-center space-x-3 text-[#020A47] hover:bg-gray-100 p-3 rounded-lg cursor-pointer transition-colors ${
                location.pathname === "/admin/dashboard/bundle/manage"
                  ? col
                  : ""
              }`}
            >
            ...
            <div className="relative">
              <li
                ...
                className={`flex items-center justify-between p-3 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                  location.pathname.includes("/admin/dashboard/practice")
                    ? col
                    : ""
                }`}
              >
              ...
              {isPracticeOpen && (
                <ul className="pl-12 mt-2 space-y-2 border-l-2 border-gray-200">
                  <li
                    onClick={() =>
                      handleNavigation("/admin/dashboard/practice/topic/add")
                    }
                    className={`flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                      location.pathname ===
                      "/admin/dashboard/practice/topic/add"
                        ? "text-[#020A47]"
                        : ""
                    }`}
                  >
                  ...
                  <li
                    onClick={() =>
                      handleNavigation("/admin/dashboard/practice/quiz/add")
                    }
                    className={`flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                      location.pathname === "/admin/dashboard/practice/quiz/add"
                        ? "text-[#020A47]"
                        : ""
                    }`}
                  >
            ...
            <li
              onClick={() => handleNavigation("/admin/dashboard/students")}
              className={`flex items-center space-x-3 text-[#020A47] hover:bg-gray-100 p-3 rounded-lg cursor-pointer transition-colors ${
                location.pathname === "/admin/dashboard/students" ? col : ""
              }`}
            >
            ...
            <li
              onClick={() =>
                handleNavigation("/admin/dashboard/paymenthistory")
              }
              className={`flex items-center space-x-3 text-[#020A47] hover:bg-gray-100 p-3 rounded-lg cursor-pointer transition-colors ${
                location.pathname === "/admin/dashboard/paymenthistory"
                  ? col
                  : ""
              }`}
            >
            ...
            <div className="relative">
              <li
                ...
                className={`flex items-center justify-between p-3 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                  location.pathname.includes("/admin/dashboard/users/students")
                    ? col
                    : ""
                }`}
              >
              ...
              {isOpenuser && (
                <ul className="pl-12 mt-2 space-y-2 border-l-2 border-gray-200">
                  <li
                    onClick={() =>
                      handleNavigation("/admin/dashboard/users/admin")
                    }
                    className={`flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                      location.pathname === "/admin/dashboard/users/admin"
                        ? "text-[#020A47]"
                        : ""
                    }`}
                  >
                  ...
                  <li
                    onClick={() =>
                      handleNavigation("/admin/dashboard/users/students")
                    }
                    className={`flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                      location.pathname === "/admin/dashboard/users/students"
                        ? "text-[#020A47]"
                        : ""
                    }`}
                  >
            ...
            <li
              onClick={() => handleNavigation("/admin/dashboard/wishlist")}
              className={`flex items-center space-x-3 text-[#020A47] hover:bg-gray-100 p-3 rounded-lg cursor-pointer transition-colors ${
                location.pathname === "/admin/dashboard/wishlist" ? col : ""
              }`}
            >
            ...
            <div className="relative">
              <li
                onClick={() => setIsFrontCMSOpen(!isFrontCMSOpen)}
                className={`flex items-center justify-between p-3 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                  location.pathname.includes("/admin/dashboard/front-cms")
                    ? col
                    : ""
                }`}
              >
              ...
              {isFrontCMSOpen && (
                <ul className="pl-12 mt-2 space-y-2 border-l-2 border-gray-200">
                  <li
                    onClick={() =>
                      handleNavigation("/admin/dashboard/front-cms/page-banner")
                    }
                    className={`flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                      location.pathname ===
                      "/admin/dashboard/front-cms/page-banner"
                        ? "text-[#020A47]"
                        : ""
                    }`}
                  >
                  ...
                  <li
                    onClick={() =>
                      handleNavigation(
                        "/admin/dashboard/front-cms/about-page-content"
                      )
                    }
                    className={`flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                      location.pathname ===
                  ...
                  <li
                    onClick={() =>
                      handleNavigation("/admin/dashboard/front-cms/partners")
                    }
                    className={`flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                      location.pathname ===
                      "/admin/dashboard/front-cms/partners"
                        ? "text-[#020A47]"
                        : ""
                    }`}
                  >
                  ...
                  <li
                    onClick={() =>
                      handleNavigation("/admin/dashboard/front-cms/experts")
                    }
                    className={`flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                      location.pathname === "/admin/dashboard/front-cms/experts"
                        ? "text-[#020A47]"
                        : ""
                    }`}
                  >
                  ...
                  <li
                    onClick={() =>
                      handleNavigation("/admin/dashboard/front-cms/faq")
                    }
                    className={`flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                      location.pathname === "/admin/dashboard/front-cms/faq"
                        ? "text-[#020A47]"
                        : ""
                    }`}
                  >
                  ...
                  <li
                    onClick={() =>
                      handleNavigation(
                        "/admin/dashboard/front-cms/WhyArambhSkills"
                      )
                    }
                    className={`flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                      location.pathname ===
                  ...
                  <li
                    onClick={() =>
                      handleNavigation(
                        "/admin/dashboard/front-cms/testimonials"
                      )
                    }
                    className={`flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                      location.pathname ===
                  ...
                  <li
                    onClick={() =>
                      handleNavigation("/admin/dashboard/front-cms/Contact")
                    }
                    className={`flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                      location.pathname === "/admin/dashboard/front-cms/Contact"
                        ? "text-[#020A47]"
                        : ""
                    }`}
                  >
            ...
            <li
              onClick={() => handleNavigation("/admin/dashboard/newsletter")}
              className={`flex items-center space-x-3 text-[#020A47] hover:bg-gray-100 p-3 rounded-lg cursor-pointer transition-colors ${
                location.pathname === "/admin/dashboard/newsletter" ? col : ""
              }`}
            >
            ...
            <div className="relative">
              <li
                ...
                className={`flex items-center justify-between p-3 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                  location.pathname.includes("/admin/dashboard/affiliate")
                    ? col
                    : ""
                }`}
              >
              ...
              {isAffiliateOpen && (
                <ul className="pl-12 mt-2 space-y-2 border-l-2 border-gray-200">
                  <li
                    onClick={() =>
                      handleNavigation("/admin/dashboard/affiliate/history")
                    }
                    className={`flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                      location.pathname === "/admin/dashboard/affiliate/history"
                        ? "text-[#020A47]"
                        : ""
                    }`}
                  >
                  ...
                  <li
                    onClick={() =>
                      handleNavigation("/admin/dashboard/affiliate/users")
                    }
                    className={`flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                      location.pathname === "/admin/dashboard/affiliate/users"
                        ? "text-[#020A47]"
                        : ""
                    }`}
                  >
            ...
            <div className="relative">
              <li
                onClick={() =>
                  setIsRewardPointsOpen &&
                  setIsRewardPointsOpen((prev) => !prev)
                }
                className={`flex items-center justify-between p-3 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                  location.pathname.includes("/admin/dashboard/rewardpoints")
                    ? col
                    : ""
                }`}
              >
              ...
              {isRewardPointsOpen && (
                <ul className="pl-12 mt-2 space-y-2 border-l-2 border-gray-200">
                  <li
                    onClick={() =>
                      handleNavigation("/admin/dashboard/rewardpoints/history")
                    }
                    className={`flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                      location.pathname ===
                      "/admin/dashboard/rewardpoints/history"
                        ? "text-[#020A47]"
                        : ""
                    }`}
                  >
                  ...
                  <li
                    onClick={() =>
                      handleNavigation(
                        "/admin/dashboard/rewardpoints/conditions"
                      )
                    }
                    className={`flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                      location.pathname ===
                  ...
                  <li
                    onClick={() =>
                      handleNavigation("/admin/dashboard/rewardpoints/settings")
                    }
                    className={`flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                      location.pathname ===
                      "/admin/dashboard/rewardpoints/settings"
                        ? "text-[#020A47]"
                        : ""
                    }`}
                  >
            ...
            <li
              onClick={() => handleNavigation("/admin/dashboard/certification")}
              className={`flex items-center space-x-3 text-[#020A47] hover:bg-gray-100 p-3 rounded-lg cursor-pointer transition-colors ${
                location.pathname === "/admin/dashboard/certification"
                  ? col
                  : ""
              }`}
            >
            ...
            <div className="relative">
              <li
                ...
                className={`flex items-center justify-between p-3 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                  location.pathname.includes("/admin/dashboard/settings")
                    ? col
                    : ""
                }`}
              >
              ...
              {isSettingsOpen && (
                <ul className="pl-12 mt-2 space-y-2 border-l-2 border-gray-200">
                  <li
                    onClick={() =>
                      handleNavigation("/admin/dashboard/settings/general")
                    }
                    className={`flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                      location.pathname === "/admin/dashboard/settings/general"
                        ? "text-[#020A47]"
                        : ""
                    }`}
                  >
                  ...
                  <li
                    onClick={() =>
                      handleNavigation("/admin/dashboard/settings/sms")
                    }
                    className={`flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                      location.pathname === "/admin/dashboard/settings/sms"
                        ? "text-[#020A47]"
                        : ""
                    }`}
                  >
                  ...
                  <li
                    onClick={() =>
                      handleNavigation("/admin/dashboard/settings/email")
                    }
                    className={`flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                      location.pathname === "/admin/dashboard/settings/email"
                        ? "text-[#020A47]"
                        : ""
                    }`}
                  >
                  ...
                  <li
                    onClick={() =>
                      handleNavigation("/admin/dashboard/settings/whatsapp")
                    }
                    className={`flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                      location.pathname === "/admin/dashboard/settings/whatsapp"
                        ? "text-[#020A47]"
                        : ""
                    }`}
                  >
                  ...
                  <li
                    onClick={() =>
                      handleNavigation("/admin/dashboard/settings/payment")
                    }
                    className={`flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                      location.pathname === "/admin/dashboard/settings/payment"
                        ? "text-[#020A47]"
                        : ""
                    }`}
                  >
                  ...
                  <li
                    onClick={() =>
                      handleNavigation("/admin/dashboard/settings/backup")
                    }
                    className={`flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors ${
                      location.pathname === "/admin/dashboard/settings/backup"
                        ? "text-[#020A47]"
                        : ""
                    }`}
                  >
