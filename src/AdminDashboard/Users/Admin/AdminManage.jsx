  ...
  return (
    <div className="p-6 ">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          onClick={() => navigate('/admin/dashboard/users/admin/add')}
          className="flex items-center gap-2 px-4 py-2 bg-[#020A47] text-white rounded-lg cursor-pointer"
        >
          <GoPlus className='text-3xl lg:text-xl ' /> Add New Admin
        </button>
      </div>
        ...
        <table className="w-full">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-4 py-3 text-left">Number Of Course</th>
                  ...
                  <div className="relative">
                    ...
                    {menuOpen === s.id && (
                      <div className="absolute right-0 top-full mt-1 w-40 bg-white rounded-lg shadow-lg z-50 border">
                        ...
                        <button
                            onClick={() => navigate('/admin/dashboard/users/admin/assignpermission')}
                            className="w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 flex items-center gap-2"
                          >
                            Assign permission
                          </button>
                          <button
                            onClick={() => navigate('/admin/dashboard/users/admin/edit')}
                            className="w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 flex items-center gap-2"
                          >
                            Edit Admin
                          </button>
